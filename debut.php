...
<div id="lightgallery" class="c1 mbr-gallery-row clearfix lightGallery">
                              ...
                              <?php
                              include('db.php');
                              $query = "SELECT * FROM fashion ORDER BY image_id DESC";
                              ...
                              $result = $statement->fetchAll();
                                ...
                                foreach($result as $row)
                                {
                                    echo'
                                     ...
                                     <div class="column img-hover-zoom--colorize"><a class="light-link " href= "admin/dark/fashion/'.$row["image_name"].'" ><img class="img-fluid rounded" src= "admin/dark/fashion/'.$row["image_name"].'" alt=""></a></div>
