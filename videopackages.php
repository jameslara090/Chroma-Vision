...
<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm nav-hover">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
            ...
            <li class="nav-item"><a class="nav-link link text-white display-4" href="about.phpfcs">ABOUT</a></li>
        </ul>
...
<section class="header7 cid-r9VWt4bHUK" id="header7-1n">
    <div class="cid-r9VWt4bHUK234">
            <center><h2 class="text-white text-style p-5">Our Services</h2></center>
            <?php
								require_once('config/db.php');
								$result = $conn->prepare("SELECT * FROM cv_packages where package_category = 'Video Packages'");
								$result->execute();
								for($i=0; $row = $result->fetch(); $i++){
								$id=$row['id'];
				?>
        <form action ="videopackages.php" method="POST">
                                ...
                                <div class="media-container">
                                        <div class="col-md-12 text-white content">
                                            ...
                                            <?php echo $row ['item_1']; ?><br>
                                                      ...
                                                      |   <a href="getintouch.php"  class="text-warning text-white mbr-fonts-style">Read More |</a>
                                            </a>
              ...
              <div class="col-md-3">
                  <div class="media">
                      ...
                      <div class="media-body">
                          ...
                          <a class="text-warning">+639474021139</a>
