        ...
        <div class="container">
            <div>
                ...
                <div class="mbr-gallery-filter container ">
                    <ul>
                    <li class="mbr-gallery-filter-all active"><a href="photography.php"><button class="btn btn-md btn-white-outline active display-7">Wedding</button></a></li>
                        <li class="mbr-gallery-filter-all"><a href="fashion.php"><button class="btn btn-md btn-white-outline active display-7">Fashion</button></a></li>
