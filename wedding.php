...
<div id="lightgallery" class="c1 mbr-gallery-row clearfix lightGallery">
                              ...
                              <?php
                              include('db.php');
                              $query = "SELECT * FROM photos WHERE category='wedding' ORDER BY photo_id";
                              ...
                              $result = $statement->fetchAll();
                                ...
                                foreach($result as $row)
                                {
                                    echo'
                                     ...
                                     <div class="column img-hover-zoom--colorize"><a class="light-link " href= "admin/dark/photos/'.$row["filename"].'" ><img class="img-fluid rounded" src= "admin/dark/photos/'.$row["filename"].'" alt=""></a></div>
