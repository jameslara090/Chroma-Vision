! function(e, t) {
    ...
    ! function() {
        ...
        function t(e, t) {
            if (this.el = e, this.$el = p(e), this.s = p.extend({}, o, t), this.s.dynamic && "undefined" !== this.s.dynamicEl && this.s.dynamicEl.constructor === Array && !this.s.dynamicEl.length) throw "When using dynamic mode, you must also define dynamicEl as an Array.";
        ...
        t.prototype.init = function() {
            ...
            if ("100%" !== this.s.height) {
                ...
                e >= parseInt(this.s.height, 10) ? o.css("top", t + "px") : o.css("top", "0px")
            }
            ...
            var t, o, s = null;
            if (this.s.dynamic ? this.s.dynamicEl[e].subHtmlUrl ? t = this.s.dynamicEl[e].subHtmlUrl : s = this.s.dynamicEl[e].subHtml : (o = this.$items.eq(e)).attr("data-sub-html-url") ? t = o.attr("data-sub-html-url") : (s = o.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !s && (s = o.attr("title") || o.find("img").first().attr("alt"))), !t)
                if (null != s) {
                    var i = s.substring(0, 1);
                    "." !== i && "#" !== i || (s = this.s.subHtmlSelectorRelative && !this.s.dynamic ? o.find(s).html() : p(s).html())
                } else s = "";
            ...
            d.s.dynamic ? (d.s.dynamicEl[t].poster && (c = !0, i = d.s.dynamicEl[t].poster), n = d.s.dynamicEl[t].html, a = d.s.dynamicEl[t].src, d.s.dynamicEl[t].responsive && u(d.s.dynamicEl[t].responsive.split(",")), l = d.s.dynamicEl[t].srcset, r = d.s.dynamicEl[t].sizes) : (d.$items.eq(t).attr("data-poster") && (c = !0, i = d.$items.eq(t).attr("data-poster")), n = d.$items.eq(t).attr("data-html"), a = d.$items.eq(t).attr("href") || d.$items.eq(t).attr("data-src"), d.$items.eq(t).attr("data-responsive") && u(d.$items.eq(t).attr("data-responsive").split(",")), l = d.$items.eq(t).attr("data-srcset"), r = d.$items.eq(t).attr("data-sizes"));
            var h = !1;
            ...
            if (!d.$slide.eq(t).hasClass("lg-loaded")) {
                if (h) d.$slide.eq(t).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + d.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>');
                    ...
                    var m;
                    m = g && g.youtube ? "lg-has-youtube" : g && g.vimeo ? "lg-has-vimeo" : "lg-has-html5", d.$slide.eq(t).prepend('<div class="lg-video-cont ' + m + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + i + '" /></div></div>')
                } else g ? (d.$slide.eq(t).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), d.$el.trigger("hasVideo.lg", [t, a, n])) : d.$slide.eq(t).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + a + '" /></div>');
                if (d.$el.trigger("onAferAppendSlide.lg", [t]), s = d.$slide.eq(t).find(".lg-object"), r && s.attr("sizes", r), l) {
                    s.attr("srcset", l);
                    try {
                        picturefill({
                            elements: [s[0]]
            ...
            d.$slide.eq(t).find(".lg-object").on("load.lg error.lg", function() {
                var e = 0;
                o && !p("body").hasClass("lg-from-hash") && (e = o), setTimeout(function() {
            ...
            if (!l.lGalleryOn || i !== e) {
                ...
                if (!l.lgBusy) {
                    var n, d, c;
                    if (this.s.download)(n = l.s.dynamic ? !1 !== l.s.dynamicEl[e].downloadUrl && (l.s.dynamicEl[e].downloadUrl || l.s.dynamicEl[e].src) : "false" !== l.$items.eq(e).attr("data-download-url") && (l.$items.eq(e).attr("data-download-url") || l.$items.eq(e).attr("href") || l.$items.eq(e).attr("data-src"))) ? (p("#lg-download").attr("href", n), l.$outer.removeClass("lg-hide-download")) : l.$outer.addClass("lg-hide-download");
                    if (this.$el.trigger("onBeforeSlide.lg", [i, e, t, o]), l.lgBusy = !0, clearTimeout(l.hideBartimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function() {
                            l.addHtml(e)
                        }, a), this.arrowDisable(e), s || (e < i ? s = "prev" : i < e && (s = "next")), t) this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"), 2 < r ? (d = e - 1, c = e + 1, 0 === e && i === r - 1 ? (c = 0, d = r - 1) : e === r - 1 && 0 === i && (c = 0, d = r - 1)) : (d = 0, c = 1), "prev" === s ? l.$slide.eq(c).addClass("lg-next-slide") : l.$slide.eq(d).addClass("lg-prev-slide"), l.$slide.eq(e).addClass("lg-current");
                    else l.$outer.addClass("lg-no-trans"), this.$slide.removeClass("lg-prev-slide lg-next-slide"), "prev" === s ? (this.$slide.eq(e).addClass("lg-prev-slide"), this.$slide.eq(i).addClass("lg-next-slide")) : (this.$slide.eq(e).addClass("lg-next-slide"), this.$slide.eq(i).addClass("lg-prev-slide")), setTimeout(function() {
                    ...
                    l.lGalleryOn ? (setTimeout(function() {
                        ...
                        l.lgBusy = !1, l.$el.trigger("onAfterSlide.lg", [i, e, t, o])
                    }, this.s.speed)) : (l.loadContent(e, !0, l.s.backdropDuration), l.lgBusy = !1, l.$el.trigger("onAfterSlide.lg", [i, e, t, o])), l.lGalleryOn = !0, this.s.counter && p("#lg-counter-current").text(e + 1)
                }
                l.index = e
            }
            ...
            var o = t - e;
            15 < Math.abs(o) && (this.$outer.addClass("lg-dragging"), this.setTranslate(this.$slide.eq(this.index), o, 0), this.setTranslate(p(".lg-prev-slide"), -this.$slide.eq(this.index).width() + o, 0), this.setTranslate(p(".lg-next-slide"), this.$slide.eq(this.index).width() + o, 0))
            ...
            t.s.enableDrag && t.doCss() && (t.$slide.on("mousedown.lg", function(e) {
                t.$outer.hasClass("lg-zoomed") || t.lgBusy || p(e.target).text().trim() || (e.preventDefault(), t.manageSwipeClass(), o = e.pageX, i = !0, t.$outer.scrollLeft += 1, t.$outer.scrollLeft -= 1, t.$outer.removeClass("lg-grab").addClass("lg-grabbing"), t.$el.trigger("onDragstart.lg"))
                ...
                l ? (l = !1, t.touchEnd(s - o), t.$el.trigger("onDragend.lg")) : (p(e.target).hasClass("lg-object") || p(e.target).hasClass("lg-video-play")) && t.$el.trigger("onSlideClick.lg"), i && (i = !1, t.$outer.removeClass("lg-grabbing").addClass("lg-grab"))
            }))
            ...
            this.$outer.find(".lg-close").on("click.lg", function() {
                ...
                o = !!(p(e.target).is(".lg-outer") || p(e.target).is(".lg-item ") || p(e.target).is(".lg-img-wrap"))
            }), t.$outer.on("mousemove.lg", function() {
                o = !1
            }), t.$outer.on("mouseup.lg", function(e) {
                (p(e.target).is(".lg-outer") || p(e.target).is(".lg-item ") || p(e.target).is(".lg-img-wrap") && o) && (t.$outer.hasClass("lg-dragging") || t.destroy())
            }))
...
function(e, t) {
    ...
    ! function() {
        ...
        e.prototype.init = function() {
            ...
            this.exitFullscreen(), o(document).off("fullscreenchange.lg webkitfullscreenchange.lg mozfullscreenchange.lg MSFullscreenChange.lg")
    ...
    ! function() {
        ...
        e.prototype.init = function() {
            ...
            t.$thumbOuter.addClass("lg-grab"), t.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function(e) {
                ...
                i && (r = t.left, l = !0, s = e.pageX, t.$thumbOuter.addClass("lg-dragging"), (r -= s - o) > t.thumbTotalWidth - t.thumbOuterWidth && (r = t.thumbTotalWidth - t.thumbOuterWidth), r < 0 && (r = 0), t.setTranslate(r))
            ...
            t.core.$outer.find(".lg-thumb").on("touchstart.lg", function(e) {
                ...
                t.thumbTotalWidth > t.thumbOuterWidth && (e.preventDefault(), s = e.originalEvent.targetTouches[0].pageX, i = !0, t.$thumbOuter.addClass("lg-dragging"), l = t.left, (l -= s - o) > t.thumbTotalWidth - t.thumbOuterWidth && (l = t.thumbTotalWidth - t.thumbOuterWidth), l < 0 && (l = 0), t.setTranslate(l))
    ...
    ! function() {
        ...
        e.prototype.init = function() {
            ...
            s.core.$el.on("hasVideo.lg.tm", function(e, t, o, s) {
                ...
                d && h(d).attr("src", h(d).attr("src").replace("&autoplay", "&noplay")), s = i.core.s.dynamic ? i.core.s.dynamicEl[o].src : i.core.$items.eq(o).attr("href") || i.core.$items.eq(o).attr("data-src");
                var u = i.core.isVideo(s, o) || {};
                (u.youtube || u.vimeo || u.dailymotion || u.vk) && i.core.$outer.addClass("lg-hide-download")
            ...
            if (o && (r = this.videoLoaded ? 0 : this.core.s.autoplayFirstVideo ? 1 : 0), n.youtube) a = "?wmode=opaque&autoplay=" + r + "&enablejsapi=1", this.core.s.youtubePlayerParams && (a = a + "&" + h.param(this.core.s.youtubePlayerParams)), l = '<iframe class="lg-video-object lg-youtube ' + t + '" width="560" height="315" src="//www.youtube.com/embed/' + n.youtube[1] + a + '" frameborder="0" allowfullscreen></iframe>';
            else if (n.vimeo) a = "?autoplay=" + r + "&api=1", this.core.s.vimeoPlayerParams && (a = a + "&" + h.param(this.core.s.vimeoPlayerParams)), l = '<iframe class="lg-video-object lg-vimeo ' + t + '" width="560" height="315"  src="//player.vimeo.com/video/' + n.vimeo[1] + a + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
            else if (n.dailymotion) a = "?wmode=opaque&autoplay=" + r + "&api=postMessage", this.core.s.dailymotionPlayerParams && (a = a + "&" + h.param(this.core.s.dailymotionPlayerParams)), l = '<iframe class="lg-video-object lg-dailymotion ' + t + '" width="560" height="315" src="//www.dailymotion.com/embed/video/' + n.dailymotion[1] + a + '" frameborder="0" allowfullscreen></iframe>';
            else if (n.html5) {
                var d = i.substring(0, 1);
                "." !== d && "#" !== d || (i = h(i).html()), l = i
            } else n.vk && (a = "&autoplay=" + r, this.core.s.vkPlayerParams && (a = a + "&" + h.param(this.core.s.vkPlayerParams)), l = '<iframe class="lg-video-object lg-vk ' + t + '" width="560" height="315" src="//vk.com/video_ext.php?' + n.vk[1] + a + '" frameborder="0" allowfullscreen></iframe>');
            return l
            ...
            if (o.find(".lg-object").hasClass("lg-has-poster") && o.find(".lg-object").is(":visible"))
                if (o.hasClass("lg-has-video")) {
                    ...
                    s.core.s.dynamic ? (r = s.core.s.dynamicEl[s.core.index].src, a = s.core.s.dynamicEl[s.core.index].html) : (r = s.core.$items.eq(s.core.index).attr("href") || s.core.$items.eq(s.core.index).attr("data-src"), a = s.core.$items.eq(s.core.index).attr("data-html")), n(r, a);
                    var d = o.find(".lg-object");
                    o.find(".lg-video").append(d), o.find(".lg-video-object").hasClass("lg-html5") || (o.removeClass("lg-complete"), o.find(".lg-video-object").on("load.lg error.lg", function() {
...
function(e, t) {
    ...
    ! function() {
        ...
        var e, t, o = {
            ...
            s = function(e) {
                return this.core = u(e).data("lightGallery"), this.core.s = u.extend({}, o, this.core.s), this.core.s.zoom && this.core.doCss() && (this.init(), this.zoomabletimeout = !1, this.pageX = u(window).width() / 2, this.pageY = u(window).height() / 2 + u(window).scrollTop()), this
            };
        s.prototype.init = function() {
            var r = this,
                e = '<span id="lg-zoom-in" class="lg-icon"></span><span id="lg-zoom-out" class="lg-icon"></span>';
            r.core.s.actualSize && (e += '<span id="lg-actual-size" class="lg-icon"></span>'), r.core.s.useLeftForZoom ? r.core.$outer.addClass("lg-use-left-for-zoom") : r.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(e), r.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(e, t, o) {
                var s = r.core.s.enableZoomAfter + o;
                u("body").hasClass("lg-from-hash") && o ? s = 0 : u("body").removeClass("lg-from-hash"), r.zoomabletimeout = setTimeout(function() {
            ...
            var a = 1,
                t = function(e) {
                    var t = r.core.$outer.find(".lg-current .lg-image"),
                        ...
                        s = (u(window).height() - t.prop("offsetHeight")) / 2 + u(window).scrollTop(),
                        i = (e - 1) * (r.pageX - o),
                        l = (e - 1) * (r.pageY - s);
                    t.css("transform", "scale3d(" + e + ", " + e + ", 1)").attr("data-scale", e), r.core.s.useLeftForZoom ? t.parent().css({
                        left: -i + "px",
                        top: -l + "px"
                    }).attr("data-x", i).attr("data-y", l) : t.parent().css("transform", "translate3d(-" + i + "px, -" + l + "px, 0)").attr("data-x", i).attr("data-y", l)
                },
                n = function() {
                    1 < a ? r.core.$outer.addClass("lg-zoomed") : r.resetZoom(), a < 1 && (a = 1), t(a)
                },
                s = function(e, t, o, s) {
                    var i, l = t.prop("offsetWidth");
                    i = r.core.s.dynamic ? r.core.s.dynamicEl[o].width || t[0].naturalWidth || l : r.core.$items.eq(o).attr("data-width") || t[0].naturalWidth || l, r.core.$outer.hasClass("lg-zoomed") ? a = 1 : l < i && (a = i / l || 2), s ? (r.pageX = u(window).width() / 2, r.pageY = u(window).height() / 2 + u(window).scrollTop()) : (r.pageX = e.pageX || e.originalEvent.targetTouches[0].pageX, r.pageY = e.pageY || e.originalEvent.targetTouches[0].pageY), n(), setTimeout(function() {
            ...
            r.core.$el.on("onAferAppendSlide.lg.tm.zoom", function(e, t) {
                ...
                r.pageX = u(window).width() / 2, r.pageY = u(window).height() / 2 + u(window).scrollTop(), t(a)
            }), u("#lg-zoom-out").on("click.lg", function() {
                r.core.$outer.find(".lg-current .lg-image").length && (a -= r.core.s.scale, n())
            }), u("#lg-zoom-in").on("click.lg", function() {
                r.core.$outer.find(".lg-current .lg-image").length && (a += r.core.s.scale, n())
            }), u("#lg-actual-size").on("click.lg", function(e) {
                s(e, r.core.$slide.eq(r.core.index).find(".lg-image"), r.core.index, !0)
            }), r.core.$el.on("onBeforeSlide.lg.tm", function() {
                a = 1, r.resetZoom()
            ...
            i.core.$slide.on("touchstart.lg", function(e) {
                if (i.core.$outer.hasClass("lg-zoomed")) {
                    ...
                    d = t.prop("offsetHeight") * t.attr("data-scale") > i.core.$outer.find(".lg").height(), ((n = t.prop("offsetWidth") * t.attr("data-scale") > i.core.$outer.find(".lg").width()) || d) && (e.preventDefault(), l = {
                ...
                if (i.core.$outer.hasClass("lg-zoomed")) {
                    var t, o, s = i.core.$slide.eq(i.core.index).find(".lg-img-wrap");
                    e.preventDefault(), a = !0, r = {
                        x: e.originalEvent.targetTouches[0].pageX,
                        y: e.originalEvent.targetTouches[0].pageY
                    }, i.core.$outer.addClass("lg-zoom-dragging"), o = d ? -Math.abs(s.attr("data-y")) + (r.y - l.y) : -Math.abs(s.attr("data-y")), t = n ? -Math.abs(s.attr("data-x")) + (r.x - l.x) : -Math.abs(s.attr("data-x")), (15 < Math.abs(r.x - l.x) || 15 < Math.abs(r.y - l.y)) && (i.core.s.useLeftForZoom ? s.css({
                        left: t + "px",
                        top: o + "px"
                    }) : s.css("transform", "translate3d(" + t + "px, " + o + "px, 0)"))
                }
            }), i.core.$slide.on("touchend.lg", function() {
                i.core.$outer.hasClass("lg-zoomed") && a && (a = !1, i.core.$outer.removeClass("lg-zoom-dragging"), i.touchendZoom(l, r, n, d))
            })
            ...
            i.core.$slide.on("mousedown.lg.zoom", function(e) {
                var t = i.core.$slide.eq(i.core.index).find(".lg-object");
                c = t.prop("offsetHeight") * t.attr("data-scale") > i.core.$outer.find(".lg").height(), d = t.prop("offsetWidth") * t.attr("data-scale") > i.core.$outer.find(".lg").width(), i.core.$outer.hasClass("lg-zoomed") && u(e.target).hasClass("lg-object") && (d || c) && (e.preventDefault(), l = {
                    x: e.pageX,
                    y: e.pageY
                }, a = !0, i.core.$outer.scrollLeft += 1, i.core.$outer.scrollLeft -= 1, i.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))
                ...
                if (a) {
                    ...
                    n = !0, r = {
                        x: e.pageX,
                        y: e.pageY
                    }, i.core.$outer.addClass("lg-zoom-dragging"), o = c ? -Math.abs(s.attr("data-y")) + (r.y - l.y) : -Math.abs(s.attr("data-y")), t = d ? -Math.abs(s.attr("data-x")) + (r.x - l.x) : -Math.abs(s.attr("data-x")), i.core.s.useLeftForZoom ? s.css({
                        left: t + "px",
                        top: o + "px"
                    }) : s.css("transform", "translate3d(" + t + "px, " + o + "px, 0)")
                }
            }), u(window).on("mouseup.lg.zoom", function(e) {
                a && (a = !1, i.core.$outer.removeClass("lg-zoom-dragging"), !n || l.x === r.x && l.y === r.y || (r = {
                    x: e.pageX,
                    y: e.pageY
                }, i.touchendZoom(l, r, d, c)), n = !1), i.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
            })
            ...
            (15 < Math.abs(t.x - e.x) || 15 < Math.abs(t.y - e.y)) && (s && (n <= -c ? n = -c : -d <= n && (n = -d)), o && (a <= -h ? a = -h : -u <= a && (a = -u)), s ? l.attr("data-y", Math.abs(n)) : n = -Math.abs(l.attr("data-y")), o ? l.attr("data-x", Math.abs(a)) : a = -Math.abs(l.attr("data-x")), i.core.s.useLeftForZoom ? l.css({
                left: a + "px",
                top: n + "px"
...
function(e) {
    ...
    function t(e) {
        var t = e || window.event,
            ...
            a = 0,
            n = 0;
        if ((e = h.event.fix(t)).type = "mousewheel", "detail" in t && (l = -1 * t.detail), "wheelDelta" in t && (l = t.wheelDelta), "wheelDeltaY" in t && (l = t.wheelDeltaY), "wheelDeltaX" in t && (i = -1 * t.wheelDeltaX), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (i = -1 * l, l = 0), s = 0 === l ? i : l, "deltaY" in t && (s = l = -1 * t.deltaY), "deltaX" in t && (i = t.deltaX, 0 === l && (s = -1 * i)), 0 !== l || 0 !== i) {
            if (1 === t.deltaMode) {
            ...
            if (r = Math.max(Math.abs(l), Math.abs(i)), (!f || r < f) && (m(t, f = r) && (f /= 40)), m(t, r) && (s /= 40, i /= 40, l /= 40), s = Math[1 <= s ? "floor" : "ceil"](s / f), i = Math[1 <= i ? "floor" : "ceil"](i / f), l = Math[1 <= l ? "floor" : "ceil"](l / f), v.settings.normalizeOffset && this.getBoundingClientRect) {
                var u = this.getBoundingClientRect();
                a = e.clientX - u.left, n = e.clientY - u.top
            }
            return e.deltaX = i, e.deltaY = l, e.deltaFactor = f, e.offsetX = a, e.offsetY = n, e.deltaMode = 0, o.unshift(e, s, i, l), p && clearTimeout(p), p = setTimeout(g, 200), (h.event.dispatch || h.event.handle).apply(this, o)
        }
    }
    ...
    function m(e, t) {
        return v.settings.adjustOldDeltas && "mousewheel" === e.type && t % 120 == 0
    }
    var p, f, e = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
    ...
    var v = h.event.special.mousewheel = {
        ...
        setup: function() {
            ...
            h.data(this, "mousewheel-line-height", v.getLineHeight(this)), h.data(this, "mousewheel-page-height", v.getPageHeight(this))
        },
        teardown: function() {
