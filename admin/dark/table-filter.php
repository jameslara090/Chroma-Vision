...
<!-- Mirrored from puffintheme.com/demo/oculux/dark/table-filter.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 02:19:21 GMT -->
<head>
<title>Oculux | Table Filter</title>
<meta charset="utf-8">
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="http://puffintheme.com/demo/oculux/assets/images/icon.svg" width="40" height="40" alt="Oculux"></div>
        <p>Please wait...</p>        
    </div>
</div>
...
<div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-left">
                    <div class="navbar-btn">
                        <a href="index-2.html"><img src="http://puffintheme.com/demo/oculux/assets/images/icon.svg" alt="Oculux Logo" class="img-fluid logo"></a>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="index-2.html"><img src="http://puffintheme.com/demo/oculux/assets/images/icon.svg" alt="Oculux Logo" class="img-fluid logo"><span>Oculux</span></a>
        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="index-2.html"><i class="icon-home"></i><span>My Page</span></a></li>
                    ...
                    <li>
                        <a href="#uiElements" class="has-arrow"><i class="icon-tag"></i><span>Icons</span></a>
                        <ul>
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="table-filter.html">Table Filter</a></li>
                    ...
                    <li><a href="http://puffintheme.com/demo/oculux/documentation/index.html"><i class="icon-doc"></i><span>Documentation</span></a></li>
                </ul>
            </nav>     
        </div>
    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">Table Filter</li>
                        </ol>
                    </nav>
                </div>            
                <div class="col-md-6 col-sm-12 text-right hidden-xs">
                    <a href="javascript:void(0);" class="btn btn-sm btn-primary btn-round" title="">Create Campaign</a>
                </div>
            </div>
        </div>
...
<!-- Mirrored from puffintheme.com/demo/oculux/dark/table-filter.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 02:19:22 GMT -->
</html>
