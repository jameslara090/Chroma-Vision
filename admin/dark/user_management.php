    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header pt-3">
                <h2><small>List of Users</small></h2>
                <ul class="header-dropdown dropdown">
                    <li><a href="new_user.php" class="btn btn-danger"><i class="fa fa-plus"></i></a></li>
            ...
            <div class="form-group">
                ...
                <?php
                             ...
                             $result = $connect->prepare("SELECT * FROM users ORDER BY id ASC");
                             $result->execute();
                ...
                <div class="col-xl-3 col-lg-4 col-md-5">
                        <div class="card">
                            <div class="body">
                                <center>
                                <img src="assets/img/user-profile.png" alt="" srcset="" hieght="150px" width="150px" >
                                <hr>
                                <small class="text-muted">Name: </small>
                                <p class="m-b-0" name="userbirth"><?php echo $row["first_name"]?> <?php echo $row["last_name"]?></p>
                                <hr>
                                <a href="view_user_profile.php<?php echo '?id='.$id; ?>"><button class="btn btn-danger">View Profile</button></a>
                                </center>
