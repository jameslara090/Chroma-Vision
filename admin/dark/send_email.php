...
if(isset($_POST['email_data']))
{
	...
	foreach($_POST['email_data'] as $row)
	{
		...
		$mail->Username = 'jameslara@chromavisionsorsogon.com';					//Sets SMTP username
		$mail->Password = 'iloveferari';					//Sets SMTP password
		$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
		$mail->From = 'jameslara@chromavisionsorsogon.com';			//Sets the From email address for the message
		$mail->FromName = 'Chroma Vision Photography';					//Sets the From name of the message
		$mail->AddAddress($row["customer_email"], $row["customer_name"]);	//Adds a "To" address
