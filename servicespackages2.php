...
<section class="header7 cid-r9VWt4bHUK" id="header7-1n">
    ...
    <div class="cid-r9VWt4bHUK234">
            ...
            <div class="menu-sub">
                   <a><center class="text-white"><a class="text-white" href="servicespackages1.php">Premier Content</a> |  <a href="servicespackages2.php" class="text-danger" >Creative Content</a> |  <a href="servicespackages3.php" class="text-white" >Standard Content</a></center></a>
                </div>
                <?php
								require_once('config/db.php');
								$result = $conn->prepare("SELECT * FROM cv_packages where package_category = 'Creative Content'");
								$result->execute();
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 text-white items-text-style p-5">
                                    ...
                                    <div class="col-md-3 p-5">
                                        <a name="production" id="production" class="bookit-button" type="submit" href='bookonline.php<?php echo '?id='.$id; ?>'>Book It</a>
                                    </div>
