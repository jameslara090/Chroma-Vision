...
<section class="header7 cid-r9VWt4bHUK" id="header7-1n">
    ...
    <div class="cid-r9VWt4bHUK234">
            ...
            <div class="menu-sub">
                   <a><center class="text-white"><a class="text-white" href="servicespackages1.php">Premier Content</a> |  <a href="servicespackages2.php" class="text-white" >Creative Content</a> |  <a href="servicespackages3.php" class="text-danger" >Standard Content</a></center></a>
                </div>
                <?php
								require_once('config/db.php');
								$result = $conn->prepare("SELECT * FROM cv_packages where package_category = 'Standard Content'");
								$result->execute();
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 text-white items-text-style p-5">
                                    ...
                                    <div class="col-md-3 p-5">
                                        <a name="standard" id="standard" class="bookit-button" type="submit" href='bookonline.php<?php echo '?id='.$id; ?>'>Book It</a>
                                    </div>
                                    <div class="media-container">
                                            <div class="col-md-12 text-white content"> 
                                                ...
                                                <?php echo $row ['item_1']; ?><br>
                                                 ...
                                                 <?php echo $row ['item_10']; ?><br>
                                                <br><a href="#" class="text-warning text-white mbr-fonts-style">|Read More |</a>
                                                </a> 
                                            </div>
                                            </div>
                            </div>
